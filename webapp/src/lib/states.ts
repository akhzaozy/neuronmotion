/**
 * Provinsi atau negara bagian per negara (kode ISO 3166-1 alpha-2).
 * Diambil dari dr5hn/countries-states-cities-database, diramping menjadi nama saja
 * agar cukup kecil untuk dibundel di frontend tanpa memperlambat pemuatan awal.
 */
